...
/* L.L. Ahiyya's Custom w/a keyboard layout. This layout is the providence of
   supreme masters, no half-stepping and no fakin' jax. */
...
[BASE] = LAYOUT_ergodox(  // layer 0 : default
        ...
        KC_LBRC,        KC_Z,         KC_X,   KC_C,   KC_V,   KC_B,   KC_TAB,
        LT(SYMB,KC_GRV),KC_QUOT,      LCTL(KC_LALT),  KC_INS, KC_CAPS,
                                                      KC_GRV,  KC_TILD,
                                                              KC_LALT,
        ...
        // right hand
             ...
             KC_ENT  ,    KC_N,   KC_M,  KC_COMM,KC_DOT, KC_SLSH,          KC_RBRC,
